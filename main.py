...
# 7.
# Программа получила на вход данные, это список кортежей: [(имя, дата_рождения), (имя, дата_рождения),(....)] , где имя и дата рождения — это строки.
...
# Дата рождения передаётся в программу в нестандартном для объектов date формате — 31.01.2021 вместо 2021-01-31. Чтобы из такой даты создать объект типа date — нужно «объяснить» программе формат, в котором пришла дата.
...
# После этого преобразования должен следовать код, который вычисляет количество дней,
# оставшихся до дня рождения — этот фрагмент программы у вас уже есть.
